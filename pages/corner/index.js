...
export default function Home({mydata}) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div>
         <div  >
            <div><Image src='https://bijouxhair.com/tim/landing/head-corner.jpg' width={720} height={288} alt='head' /></div>
        </div>
        <div >
...
export async function getServerSideProps() {
  let response = await fetch('https://ghanabraid.com/api/corner');
