...
export default function Home({mydata}) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div>
         <div  >
            <div><Image src='https://bijouxhair.com/tim/landing/head-victor1.jpg' width={720} height={288} className={styles.head} alt='head'/></div>
        </div>
        <div >
...
export async function getServerSideProps() {
  let response = await fetch('https://ghanabraid.com/api/victor');
